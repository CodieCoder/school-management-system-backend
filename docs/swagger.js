        ...
        paths: {
            ...
            '/school/createSchool': {
                post: {
                    ...
                    description: 'Creates a school and auto-assigns the creator as owner.',
                    security: [{ TokenAuth: [] }],
                    requestBody: { required: true, content: { 'application/json': { schema: {
                        type: 'object',
                        required: ['name'],
            ...
            '/school/getSchools': {
                get: {
                    ...
                    description: 'Returns schools the user is a member of. Superadmins see all.',
                    security: [{ TokenAuth: [] }],
            ...
            '/school/deleteSchool': {
                delete: {
                    ...
                    description: 'Cascades: removes classrooms, students, memberships, and school-scoped roles.',
                    security: [{ TokenAuth: [] }],
                    requestBody: { required: true, content: { 'application/json': { schema: {
                        type: 'object',
                        required: ['schoolId'],
            ...
            '/student/getStudents': {
                get: {
                    ...
                    parameters: [
                        ...
                        { name: 'classroomId', in: 'query', required: false, schema: { type: 'string' } },
                    ],
            ...
            '/student/transferStudent': {
                post: {
                    ...
                    description: 'Moves a student to a new school. Clears classroom assignment.',
                    security: [{ TokenAuth: [] }],
                    requestBody: { required: true, content: { 'application/json': { schema: {
                        type: 'object',
            ...
            '/role/deleteRole': {
                delete: {
                    ...
                    description: 'Fails if isSystem is true. Removes memberships using this role.',
                    security: [{ TokenAuth: [] }],
                    requestBody: { required: true, content: { 'application/json': { schema: {
                        type: 'object',
                        required: ['roleId'],
