...
You are tasked with developing a **School Management System API** using our standard project template available at: [https://github.com/qantra-io/axion](https://github.com/qantra-io/axion).

Please maintain the existing architectural patterns and structure of the template.
...
- Utilize either MongoDB or Redis for data persistence
...
- Role-based permissions:
  ...
  - **School Administrator**: School-specific access (limited to their assigned school's resources)
...
4. Complete the submission form with the following:
   - Repository URL
...
Please submit your completed challenge within **3 calendar days** of receiving this email. The deadline for submission is **[Date + 3 days] at 11:59 PM (Local Time)**.
